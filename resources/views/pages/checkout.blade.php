                  ...
                  <table class="table">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td class="align-middle">
                          {{\Carbon\Carbon::createFromDate($detail->sall_passport) >
                ...
                <div class="member mt-3">
                  ...
                  <form>
                    <div class="row form-group">
                      ...
                      <div class="col-auto">
                        <label for="nationalty" class="visually-hidden"></label>
                        <input type="text" name="nationaliy" class="form-control mb-2 mr-sm-2" style="width: 50px;"
                          id="inputNationalty" placeholder="Nationality" />
                      </div>
                      <div class="col-auto">
                        <label for="inputVisa" class="visually-hidden"></label>
                      ...
                      <div class="col-auto">
                        <label for="sallPassport" class="visually-hidden">SALL Passport</label>
                        <div class="input-group mb-2 me-sm-2">
                          <input type="text" class="form-control datepicker" id="sallPassport"
                            placeholder="SALL Passport" />
                        </div>
                      </div>
                      <div class="col-auto">
            ...
            <div class="card card-details card-right">
              ...
              <table class="trip-informations">
                ...
                <tr>
                  ...
                  <td width="50%" class="text-right">
                    {{$item->travel_package->Additional_visa}},00</td>
                </tr>
                <tr>
              ...
              <div class="bank">
                <div class="bank-item pb-3">
                  <img
                    src="{{url('frontend/image/ic_bank.png')}}"
                    alt=""
                    class="bank-image"
                  />
