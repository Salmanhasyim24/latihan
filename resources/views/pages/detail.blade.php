          ...
          <div class="col-lg-8 ps-lg-0">
            <div class="card card-details">
             ...
             <div class="features row">
               <div class="col-md-4">
                 <img 
                 src="{{url('frontend/image/ic_event.png')}}"
                  alt=""
               ...
               <div class="col-md-4 border-end">
                <img 
                 src="{{url('frontend/image/ic_language.png')}}"
                  alt=""
                  class = "features-image"
                 />
                <div class="description">
              ...
              <div class="col-md-4 border-end">
                <img 
                 src="{{url('frontend/image/ic_foods.png')}}"
                  alt=""
                  class = "features-image"
                 />
                <div class="description">
       ...
       <div class="col-lg-4">
        <div class="card card-details card-right">
          ...
          <div class="members my-3">
            <img src="frontend/image/members.png" alt="" class="w-75" />
          </div>
          <hr />
